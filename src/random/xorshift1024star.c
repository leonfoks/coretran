...
/* NOTE: as of 2017-10-08, this generator has a different multiplier (a
   ...
   Note that the two lowest bits of this generator are LSFRs, and thus
   will fail binary rank tests. We suggest to use a sign test to extract a
   random Boolean value, and right shifts to extract subsets of bits.
